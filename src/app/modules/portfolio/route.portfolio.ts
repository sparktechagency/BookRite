...
router.get('/me/all', auth(USER_ROLES.USER, USER_ROLES.ADMIN), portfolioController.getUserPortfolios);
router.get('/me/:userId', auth(USER_ROLES.USER, USER_ROLES.ADMIN), portfolioController.getPortfolioByProviderId);
router.post('/me', auth(USER_ROLES.USER, USER_ROLES.ADMIN), upload, portfolioController.createPortfolioController);
